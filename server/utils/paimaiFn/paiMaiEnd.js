...
const { asyncGetKnapsack } = require('../knapsackFn/asyncGetKnapsack');
...
module.exports = {
    ...
    paiMaiEnd: async function (req, res, itme) {
        ...
        // 竞拍方获得物品
        const { data } = await asyncGetKnapsack(req, res, { role_id: offer_id });
        const { data: list } = addArticle(article, data, true);
