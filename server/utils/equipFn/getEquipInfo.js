...
module.exports = {
     ...
     * @param {*} equip.tips 描述
     * @param {*} equip.custom 法宝的属性
     * @param {*} equip.group 套装组
     * @param {*} equip.ext 强化，锻造，附魔,宝石等,默认0_0_0_0_0_0_0_0
     * @returns {*} posName 装备部位中文
     * @returns {*} attr 装备属性
     */
    getEquipInfo: function (equipId, ext) {

        const { pos, career, attr, level, custom, ext = '0_0_0_0_0_0_0_0' } = equip
        // 解析强化，锻造，附魔,宝石
        ...
        const equipAttr = {};
        const posInfo = pos < 8 ? EQUIP_ATTR[pos] : { pos: 'treasure1', attr: custom };
