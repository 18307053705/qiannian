...
function getValue(key, value, type, base) {
    return type == '0' ? Math.floor(base[key] * value / 100) : value;
};

const EffectMap = {
    // 生命
    life_max: function (value, attr, type, base) {
        const add = getValue('life_max', value, type, base);
        attr['life_max'] += add;
        attr['life'] += add;
        return {
            text: `生命上限+${add}`,
    ...
    mana_max: function (value, attr, type, base) {
        const add = getValue('mana_max', value, type, base);
        attr['mana_max'] += add;
        attr['mana'] += add;
        return {
            text: `法力上限+${add}`,
    ...
    atk: function (value, attr, type, base) {
        const add_max = getValue('atk_max', value, type, base);
        const add_min = getValue('atk_min', value, type, base);
    ...
    dfs: function (value, attr, type, base) {
        const add_max = getValue('dfs_max', value, type, base);
        const add_min = getValue('dfs_min', value, type, base);
    ...
    hit: function (value, attr, type, base) {
        const add = getValue('hit', value, type, base);
        attr['hit'] += add;
        return {
            text: `命中+${add}`,
            value: add,
    ...
    dodge: function (value, attr, type, base) {
        const add = getValue('dodge', value, type, base);
        attr['dodge'] += add;
        return {
            text: `闪避+${add}`,
            value: add,
    ...
    sudden: function (value, attr, type, base) {
        const add = getValue('sudden', value, type, base);
        attr['sudden'] += add;
        return {
            text: `暴击+${add}`,
            value: add,
    ...
    ice_atk: function (value, attr, type, base) {
        const add_max = getValue('ice_atk_max', value, type, base);
        const add_min = getValue('ice_atk_min', value, type, base);
    ...
    ice_dfs: function (value, attr, type, base) {
        const add_max = getValue('ice_dfs_max', value, type, base);
        const add_min = getValue('ice_dfs_min', value, type, base);
    ...
    mine_atk: function (value, attr, type, base) {
        const add_max = getValue(' mine_atk_max', value, type, base);
        const add_min = getValue(' mine_atk_min', value, type, base);
    ...
    mine_dfs: function (value, attr, type, base) {
        const add_max = getValue(' mine_dfs_max', value, type, base);
        const add_min = getValue(' mine_dfs_min', value, type, base);
    ...
    wind_atk: function (value, attr, type, base) {
        const add_max = getValue('wind_atk_max', value, type, base);
        const add_min = getValue('wind_atk_min', value, type, base);
    ...
    wind_dfs: function (value, attr, type, base) {
        const add_max = getValue('wind_dfs_max', value, type, base);
        const add_min = getValue('wind_dfs_min', value, type, base);
    ...
    water_atk: function (value, attr, type, base) {
        const add_max = getValue('water_atk_max', value, type, base);
        const add_min = getValue('water_atk_min', value, type, base);
    ...
    water_dfs: function (value, attr, type, base) {
        const add_max = getValue('water_dfs_max', value, type, base);
        const add_min = getValue('water_dfs_min', value, type, base);
    ...
    fire_atk: function (value, attr, type, base) {
        const add_max = getValue('fire_atk_max', value, type, base);
        const add_min = getValue('fire_atk_min', value, type, base);
    ...
    fire_dfs: function (value, attr, type, base) {
        const add_max = getValue('fire_dfs_max', value, type, base);
        const add_min = getValue('fire_dfs_min', value, type, base);
